...
sum_multiples_x:
	...
	pushq 	%rbp
	movq	%rsp, %rbp
	subq	$16, %rsp			# allocate 16 bytes on the stack for the variables sum and multiple.
	
	movl	$0, -8(%rbp)		# sum = 0
	movl	%esi, %ecx			# save the value of x
	andl	$0xFF00, %ecx		# x & secondByteMask
	movl	%ecx, -16(%rbp)		# multiple = x & secondByteMask
	sarl	$8,	-16(%rbp)		# multiple >> 8
